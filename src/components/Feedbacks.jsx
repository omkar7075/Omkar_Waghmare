...
const Feedbacks = () => {
  const downloadCV = () => {
    const cvUrl = "https://drive.google.com/file/d/1u4jct8QjUWHQiKU0iKh_YKtKPSMJ6Spd/view?usp=sharing"; // Update this URL to the correct path of your CV
  ...
  return (
    <div className={`mt-12 bg-black-100 rounded-[20px]`}>
      <div className={`bg-tertiary rounded-2xl ${styles.padding} min-h-[300px]`}>
        ...
        <div className="relative duration-500 hover:-rotate-0 group [transform:rotate3d(1,-1,1,60deg)] border border-sky-900 border-4 overflow-hidden rounded-2xl relative h-96 w-64 bg-sky-800 p-5 flex flex-col items-start gap-4">
          <div className={`-mt-20 pb-14 ${styles.paddingX} flex flex-wrap gap-7`}>
            ...
            <button
              ...
              onClick={'https://drive.google.com/file/d/1u4jct8QjUWHQiKU0iKh_YKtKPSMJ6Spd/view?usp=sharing'}
            >
              Download CV
              <svg
